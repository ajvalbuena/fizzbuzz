import {reportRepair, reportRepair3} from "./reportRepair";
...
describe('firstDayChallenge - Report Repair', () => {

    it("should return the multiplication of the two entries that sum to 2020", () => {
        const expenses: Array<number> = [1721, 979, 366, 299, 675, 1456];
        const expectedOutput = 514579;
        expect(reportRepair(expenses, 2020)).toEqual(expectedOutput)
    ...
    it('should return the result of the challenge with the given inputs (2 entries)', () => {
        ...
        expect(reportRepair(puzzleInput,2020)).toEqual(expectedOutput)
    });

    it("should return the multiplication of the three entries that sum to 10", () => {

        const expenses: Array<number> = [1,5,7,4,9,8];
        const expectedOutput = 20;
        expect(reportRepair3(expenses,10)).toEqual(expectedOutput)

    });

    it("should return the multiplication of the three entries that sum to 420000", () => {

        const expenses: Array<number> = [28, 33, 518, 60, 140, 50, 312, 678];
        const expectedOutput = 420000;
        expect(reportRepair3(expenses,250)).toEqual(expectedOutput)

    });

    it('should return the result of the challenge with the given inputs (3 entries)', () => {
        const expectedOutput = 272423970;
        expect(reportRepair3(puzzleInput,2020)).toEqual(expectedOutput)
    });
